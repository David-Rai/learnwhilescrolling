          ...
          <div className="overflow-hidden">
            <div className="p-8">
              ...
              <div className="text-center mb-8">
                <h1
                  className="text-3xl font-bold bg-primary
              bg-clip-text text-transparent mb-2"
                >
                  Learnwhilescrolling
                </h1>
                <p className="text-gray-300 text-sm">
                  Sign up to scroll infinite forever
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-3 py-3 border rounded-lg bg-gray-50 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 ${
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-10 py-3 border rounded-lg bg-gray-50 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 ${
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-white rounded-2xl text-gray-500">
                      OR
                    </span>
                  </div>
                </div>
